...
#define DT_DRV_COMPAT telink_tlx_flash_controller
...
#include <stdlib.h>
	...
	CONFIG_SOC_RISCV_TELINK_TL521X || CONFIG_SOC_RISCV_TELINK_TL721X
...
static inline void flash_tlx_lock_init(void)
{
