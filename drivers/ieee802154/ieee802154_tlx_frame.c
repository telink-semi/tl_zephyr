...
tlx_ieee802154_frame_parse(const uint8_t *buf, size_t bul_len,
 ...
 */
ALWAYS_INLINE static bool
tlx_ieee802154_frame_build(const struct ieee802154_frame *frame,
...
tlx_ieee802154_get_data(const uint8_t *payload,
	size_t payload_len)
{
...
ALWAYS_INLINE static void
ieee802154_tlx_crypto_start(struct ieee802154_crypto_ctx *ctx,
...
ALWAYS_INLINE static void
ieee802154_tlx_crypto_header(struct ieee802154_crypto_ctx *ctx, const uint8_t *open)
{
...
ALWAYS_INLINE static void
ieee802154_tlx_crypto_payload(struct ieee802154_crypto_ctx *ctx,
...
ALWAYS_INLINE static void
ieee802154_tlx_crypto_finish(struct ieee802154_crypto_ctx *ctx, uint8_t *tag)
{
	ieee802154_tlx_crypto_ecb(ctx->key, ctx->ctr, ctx->ctr_pad);
...
ALWAYS_INLINE static bool
ieee802154_tlx_crypto_check(struct ieee802154_crypto_ctx *ctx, const uint8_t *tag)
{
	bool result = true;
